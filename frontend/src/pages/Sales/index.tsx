    ...
    <div>
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">Registro de vendas</p>
        </div>
              ...
              <tbody className="divide-y divide-gray-100">
                {sales.map((s) => (
                  <tr key={s.id} className="hover:bg-gray-50">
                    <td className="py-3 px-4 text-gray-500">{new Date(s.created_at).toLocaleDateString('pt-BR')}</td>
                    ...
                    <td className="py-3 px-4 text-gray-500">{s.notes || '-'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
