export function About() {
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-brand-ivorySmoke mb-2">Sobre o Nexus Business Manager</h1>
        <p className="text-gray-500 dark:text-brand-roseGold">Sistema ERP SaaS completo para gestao empresarial</p>
      </div>

      <section className="card">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-ivorySmoke mb-4">O que e</h2>
      ...
      <section className="card">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-ivorySmoke mb-4">Objetivo</h2>
        <p className="text-gray-600 dark:text-gray-300">
      ...
      <section className="card">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-ivorySmoke mb-4">Problemas que resolve</h2>
      ...
      <section className="card">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-ivorySmoke mb-4">Quem pode utilizar</h2>
        <ul className="space-y-2 text-gray-600 dark:text-gray-300">
      ...
      <section className="card">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-ivorySmoke mb-4">Beneficios</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-600 dark:text-gray-300">
          <div className="p-4 rounded-lg bg-gray-50 dark:bg-brand-blackCherry/50">
      ...
      <section className="card">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-ivorySmoke mb-4">Estrutura SaaS</h2>
        <p className="text-gray-600 dark:text-gray-300 mb-4">
      ...
      <section className="card">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-ivorySmoke mb-4">Multiempresa</h2>
        <p className="text-gray-600 dark:text-gray-300 mb-4">
          O suporte a multiplas empresas e nativo na arquitetura do sistema:
        </p>
        <ul className="space-y-2 text-gray-600 dark:text-gray-300">
          <li className="flex gap-2"><span className="text-brand-roseGold mt-1">&#8226;</span> Cada tabela possui uma coluna <code className="text-xs bg-gray-100 dark:bg-brand-blackCherry px-1 rounded">company_id</code></li>
      ...
      <section className="card">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-ivorySmoke mb-4">Seguranca</h2>
        <p className="text-gray-600 dark:text-gray-300 mb-4">
      ...
      <section className="card">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-ivorySmoke mb-4">Auditoria</h2>
        <p className="text-gray-600 dark:text-gray-300 mb-4">
      ...
      <section className="card">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-ivorySmoke mb-4">Escalabilidade</h2>
        <p className="text-gray-600 dark:text-gray-300 mb-4">
      ...
      <section className="card">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-ivorySmoke mb-4">Niveis de usuarios</h2>
        <div className="space-y-4">
          <div className="p-4 rounded-lg border border-purple-200 dark:border-purple-800">
            <h3 className="font-semibold text-purple-700 dark:text-purple-300 mb-2">Administrador</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300">Controle total do sistema. Pode gerenciar usuarios, empresas, configuracoes e auditar todas as acoes.</p>
          </div>
          <div className="p-4 rounded-lg border border-blue-200 dark:border-blue-800">
            <h3 className="font-semibold text-blue-700 dark:text-blue-300 mb-2">Gerente</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300">Controle operacional. Pode gerenciar cadastros, operacoes e visualizar relatorios gerenciais.</p>
          </div>
          <div className="p-4 rounded-lg border border-green-200 dark:border-green-800">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Pode realizar cadastros e operacoes do dia a dia, como registrar vendas, compras e movimentacoes.</p>
          </div>
          <div className="p-4 rounded-lg border border-gray-200 dark:border-gray-600">
            <h3 className="font-semibold text-gray-700 dark:text-gray-300 mb-2">Visualizador</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300">Acesso somente leitura. Pode consultar dados e gerar relatorios, mas nao pode criar ou alterar registros.</p>
          </div>
        </div>
      </section>

      <section className="card">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-brand-ivorySmoke mb-4">Direitos e Deveres</h2>

        <h3 className="text-lg font-medium text-gray-900 dark:text-brand-ivorySmoke mt-6 mb-3">Usuario</h3>
        ...
        <h3 className="text-lg font-medium text-gray-900 dark:text-brand-ivorySmoke mt-6 mb-3">Administrador</h3>
